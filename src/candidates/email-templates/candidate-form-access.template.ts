...
export function getCandidateFormAccessEmailTemplate(
  ...
  const contentAfterButton = [
    ...
    '<strong>⚠️ ATENÇÃO:</strong> Após preencher e <strong>submeter</strong> este formulário, os demais formulários do processo serão enviados automaticamente para as pessoas que você indicar. Por favor, complete o quanto antes para não atrasar o processo.'
  ]
